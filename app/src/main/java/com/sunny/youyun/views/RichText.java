...
public class RichText extends AppCompatTextView {
    ...
    public RichText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        getAttrs(context, attrs, R.styleable.RichText);
    ...
    private void getAttrs(Context context, AttributeSet attrs, int[] imageButton) {
        TypedArray ta = context.obtainStyledAttributes(attrs, imageButton);
        drawableHeight = ta.getDimensionPixelSize(R.styleable.RichText_drawable_height, 0);
        drawableWidth = ta.getDimensionPixelSize(R.styleable.RichText_drawable_width, 0);
        drawable = ta.getDrawable(R.styleable.RichText_drawable_src);
        drawableLocation = ta.getInt(R.styleable.RichText_drawable_location, LEFT);
        ta.recycle();
    }
