...
public class LineMenuSwitch extends RelativeLayout{
    ...
    private void initView() {
        ...
        RelativeLayout.LayoutParams title_param = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
        ...
        RelativeLayout.LayoutParams switch_param = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private void getAttr(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        leftMargin = ta.getDimensionPixelSize(R.styleable.LineMenuSwitch_left_margin, DensityUtil.dip2px(context, DEFAULT_MARGIN));
        rightMargin = ta.getDimensionPixelOffset(R.styleable.LineMenuSwitch_right_margin, DensityUtil.dip2px(context, DEFAULT_MARGIN));
